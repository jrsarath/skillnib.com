        ...
        <div class="row no-gliters">
          <div class="col">
            <div class="company-details p-0">
              <div class="institute-cover" style='background-image: url(<?php echo $app->clg_details($i, "cover_image") ?>)'>
                <div class="overlay"></div>
                <div class="meta-details">
                  <div class="container-fluid row">
                    <div class="col-md-8">
                      <ul>
                        <li><h3><?php echo $app->clg_details($i, 'name'); ?></h3></li>
                        <li>
                          <b class='rating'><?php echo $app->text_rating($i, 'college'); ?></b>
                          <span>
                            <?php echo $app->get_total_rating($i, 'college'); ?>
                          </span>
                        </li>
                        <li><i class="far fa-compass"></i><b><?php echo $app->clg_details($i, 'city'); ?>, <?php echo $app->clg_details($i, 'state'); ?></b></li>
                        <li><i class="fas fa-certificate"></i><b><?php echo $app->clg_details($i, 'specialization'); ?></b></li>
                        <li><i class="fas fa-rupee-sign"></i><b>₹<?php echo $app->clg_details($i, 'fee_range'); ?></b></li>
                      </ul>
                    </div>
                    <div class="col-md-4">
                      <img src="<?php echo $app->clg_details($i, "profile_image") ?>" class="img-responsive float-right">
                    </div>
                  </div>
                </div>
                <div class="institute-actions">
                  <ul>
                    ...
                    <li>
                      <?php if ($app->clg_details($i, 'verified') == 'true'): ?>
              ...
              <div class="row p-5">
                <div class="dashboard-sidebar col-md-4">
                  <div class="portfolio">
                    <div class="owl-carousel" id="inst-images">
                      <?php $app->clg_details($i, 'images') ?>
                    </div>
                  </div>
                  <div class="item">
                    <i class="fas fa-city"></i><b> City :</b>
                    <?php echo $app->clg_details($i, 'city'); ?>
                  </div>
                  <?php if (!empty($app->clg_details($i, 'state'))): ?>
                    <div class="item">
                      <i class="far fa-compass"></i><b> State :</b>
                      <?php echo $app->clg_details($i, 'state'); ?>
                    </div>
                  <?php endif; ?>
                  <div class="item">
                    <i class="fas fa-book"></i><b> Study Mode :</b>
                    <?php echo $app->clg_details($i, 'study_mode'); ?>
                  </div>
                  <div class="item">
                    <i class="fas fa-certificate"></i><b> Specialization :</b>
                    <?php echo $app->clg_details($i, 'specialization'); ?>
                  </div>
                  <div class="item">
                    <i class="fas fa-rupee-sign"></i><b> Fee's Range :</b>
                    ₹<?php echo $app->clg_details($i, 'fee_range'); ?>
                  </div>
                  <div class="item">
                    <i class="fas fa-flag"></i><b> Institute Type :</b>
                    <?php echo $app->clg_details($i, 'institute_type'); ?>
                  </div>
                  <div class="item">
                    <i class="fas fa-building"></i><b> Hostel :</b>
                    <?php echo $app->clg_details($i, 'hostel'); ?>
                  </div>
                  <div class='item'>
                    <hr>
                    <h6 class="mt-5 mb-4">Exams</h6>
                    <div><?php $app->clg_details($i, 'exams'); ?></div>
                  </div>
                  <div class='tags'>
                    <hr>
                    <h6 class="mt-5 mb-4">Tags</h6>
                    <div><?php $app->clg_details($i, 'tags'); ?></div>
                  </div>
                ...
                <div class="dashboard-content-wrapper col-md-8">
                  ...
                  <ul class="nav nav-tabs">
                    ...
                    <?php if ($_SESSION['user_id'] != $app->clg_details($i, 'owner')): ?>
                      <li class="nav-item">
                  ...
                  <div class="tab-content mb-5">
                    <?php if (isset($status) && $status == 'success'): ?>
                      <div class="alert alert-success alert-dismissible fade show mt-5" role="alert">
                        <strong>Yayy!</strong> You successfully reviewed <b><?php echo $app->clg_details($i, 'name'); ?></b>
                    ...
                    <?php elseif (isset($status) && $status == 'duplicate'): ?>
                      <div class="alert alert-warning alert-dismissible fade show mt-5" role="alert">
                        <strong>Oh uh!</strong> You already reviewed <b><?php echo $app->clg_details($i, 'name'); ?></b>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                          <i class="far fa-times-circle" style='font-size: 24px;'></i>
                        </button>
                      </div>
                    ...
                    <div id="details" class="container tab-pane active">
                      <div class="addictional-content mt-5">
                        <h5>Facilities</h5>
                        <p class="my-4"><?php echo $app->clg_details($i, 'facilities'); ?></p>
                        <br>
                        <h5>Degrees</h5>
                        <p class="my-4"><?php echo $app->clg_details($i, 'services'); ?></p>
                      </div>
                    </div>
