        ...
        <div class="row no-gliters">
          <div class="col">
            <div class="company-details p-0">
              <div class="institute-cover" style='background-image: url(<?php echo $app->job_details($i, "cover_image") ?>)'>
                <div class="overlay"></div>
                <div class="meta-details">
                  <div class="container-fluid row">
                    <div class="col-md-8">
                      <ul>
                        <li><h3><?php echo $app->job_details($i, 'name'); ?></h3></li>
                        <li>
                          <b class='rating'><?php echo $app->text_rating($i, 'job_consultancy'); ?></b>
                          <span>
                            <?php echo $app->get_total_rating($i, 'job_consultancy'); ?>
                          </span>
                        </li>
                        <li><i class="far fa-compass"></i><b><?php echo $app->job_details($i, 'city'); ?>, <?php echo $app->job_details($i, 'state'); ?></b></li>
                        <li><i class="fas fa-rupee-sign"></i><b>₹<?php echo $app->job_details($i, 'fee_range'); ?></b></li>
                      </ul>
                    </div>
                    <div class="col-md-4">
                      <img src="<?php echo $app->job_details($i, "profile_image") ?>" class="img-responsive float-right">
                    </div>
                  </div>
                </div>
                <div class="institute-actions">
                  <ul>
                    ...
                    <li>
                      <?php if ($app->job_details($i, 'verified') == 'true'): ?>
              ...
              <div class="row p-5">
                <div class="dashboard-sidebar col-md-4">
                  <div class="portfolio">
                    <div class="owl-carousel" id="inst-images">
                      <?php $app->job_details($i, 'images') ?>
                    </div>
                  </div>
                  <div class="item">
                    <i class="fas fa-city"></i><b> City :</b>
                    <?php echo $app->job_details($i, 'city'); ?>
                  </div>
                  <?php if (!empty($app->job_details($i, 'state'))): ?>
                    <div class="item">
                      <i class="far fa-compass"></i><b> State :</b>
                      <?php echo $app->job_details($i, 'state'); ?>
                    </div>
                  <?php endif; ?>
                  <div class="item">
                    <i class="fas fa-rupee-sign"></i><b> Fee's Range :</b>
                    ₹<?php echo $app->job_details($i, 'fee_range'); ?>
                  </div>
                  <div class='tags'>
                    <hr>
                    <h6 class="mt-5 mb-4">Tags</h6>
                    <div><?php $app->job_details($i, 'tags'); ?></div>
                  </div>
                ...
                <div class="dashboard-content-wrapper col-md-8">
                  ...
                  <ul class="nav nav-tabs">
                    ...
                    <?php if ($_SESSION['user_id'] != $app->job_details($i, 'owner')): ?>
                      <li class="nav-item">
                  ...
                  <div class="tab-content mb-5">
                    <?php if (isset($status) && $status == 'success'): ?>
                      <div class="alert alert-success alert-dismissible fade show mt-5" role="alert">
                        <strong>Yayy!</strong> You successfully reviewed <b><?php echo $app->job_details($i, 'name'); ?></b>
                    ...
                    <?php elseif (isset($status) && $status == 'duplicate'): ?>
                      <div class="alert alert-warning alert-dismissible fade show mt-5" role="alert">
                        <strong>Oh uh!</strong> You already reviewed <b><?php echo $app->job_details($i, 'name'); ?></b>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                          <i class="far fa-times-circle" style='font-size: 24px;'></i>
                        </button>
                      </div>
                    ...
                    <div id="details" class="container tab-pane active">
                      <div class="addictional-content mt-5">
                        <h5>Facilities</h5>
                        <p class="my-4"><?php echo $app->job_details($i, 'facilities'); ?></p>
                        <br>
                        <h5>Degrees</h5>
                        <p class="my-4"><?php echo $app->job_details($i, 'services'); ?></p>
                      </div>
                    </div>
                    <div id="post" class="container tab-pane">
                      ...
                      <div class="timeline">
                        ...
                        <?php $app->get_posts($i, 'job_consultancy'); ?>
                      </div>
                    </div>
                    ...
                    <div id="check-review" class="container tab-pane fade">
                      <br>
                      <?php $app->get_reviews($i, 'job_consultancy'); ?>
                    </div>
