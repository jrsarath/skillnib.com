  ...
  <head>
    ...
    <style>
      .hero_in.hotels_detail:before {
          background: url({$app->int_details($i, 'cover_image')}) center center no-repeat !important;
            ...
            <div class="row">
              ...
              <aside class="col-lg-4" id="sidebar">
                <div class="box_detail booking">
                  ...
                  <p><i class="icon icon-globe"></i><a href='{if strpos($app->int_details($i, "website"), "http") == true}{$app->int_details($i, "website")}{else}http://{$app->int_details($i, "website")}{/if}'>{$app->int_details($i, "website")}</a></p>
